...
enum class DoubleKey(
    ...
    meal_modes_MaxBasal_genericmeal("meal_modes_max_basal_genericmeal", 1.0, 0.05, 25.0),
    meal_modes_MaxBasal_bfast("meal_modes_max_basal_bfast", 1.0, 0.05, 25.0),
    meal_modes_MaxBasal_lunch("meal_modes_max_basal_lunch", 1.0, 0.05, 25.0),
    meal_modes_MaxBasal_dinner("meal_modes_max_basal_dinner", 1.0, 0.05, 25.0),
    meal_modes_MaxBasal_highcarb("meal_modes_max_basal_highcarb", 1.0, 0.05, 25.0),
    meal_modes_MaxBasal_snack("meal_modes_max_basal_snack", 0.1, 0.05, 10.0),
