 ...
 * `adb logcat | grep DEXCOM_ONEPLUS` keeps working while a developer is watching.
 *
 ...
 */
internal object OnePlusLog {

    private val logger: Logger = LoggerFactory.getLogger(OnePlusLogMarkers.TAG)
