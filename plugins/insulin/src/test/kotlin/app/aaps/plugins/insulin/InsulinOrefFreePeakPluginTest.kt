...
class InsulinOrefFreePeakPluginTest : TestBaseWithProfile() {
    ...
    @BeforeEach
    fun setup() {
        sut = InsulinOrefFreePeakPlugin(rh, preferences, aapsSchedulers, fabricPrivacy, persistenceLayer, profileFunction, rxBus, aapsLogger, config, hardLimits, uiInteraction, context)
    }
